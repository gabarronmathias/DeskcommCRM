...
**Branch:** `feat/canais-oficial` · **Worktree:** `~/G&M CRM-canais`
...
continuam idênticos e verdes. Commitado com `GMCRM_GOV_INVARIANTS_EDIT=1` citado no
commit message.
