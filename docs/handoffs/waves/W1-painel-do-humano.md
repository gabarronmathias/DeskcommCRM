...
**Worktree:** `/Users/rafaelmelgaco/G&M CRM-ia360-w1-painel` (branch `feat/ia-360-w1-painel`, base `d25cd1c`)
...
O resumo do porquê: o G&M CRM tem um agente de IA que sabe conversar mas não sabe operar, e o
