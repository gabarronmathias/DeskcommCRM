...
- ✅ **Repositório no GitHub**: https://github.com/melgarafael/G&M CRM
...
| **GitHub repo** | https://github.com/melgarafael/G&M CRM (private) |
...
- **Memórias persistentes do projeto** em `~/.claude/projects/-Users-rafaelmelgaco-G&M CRM/memory/`
  ...
  - `project_naming_and_timeline.md` — G&M CRM, MVP-B 8-12 semanas
...
- Pitch deck pode ser renderizado com:
  ...
  ```
- GitHub repo: https://github.com/melgarafael/G&M CRM (mostre as docs)
- Supabase Studio: dashboard.supabase.com → projeto G&M CRM → Database → Tables (31 tabelas com RLS verde)
