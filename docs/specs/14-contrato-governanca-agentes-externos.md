...
> G&M CRM via MCP: quais tools existem, o input/output exato de cada uma, a
...
O G&M CRM expõe um **servidor MCP org-scoped**. O agente externo se autentica
...
> G&M CRM**; o lado do Vendaval é o FG-01.
