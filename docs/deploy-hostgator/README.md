# Como subir o seu G&M CRM na HostGator (passo a passo, sem enrolação)
...
```
Seu domínio  →  Servidor VPS (HostGator)  →  G&M CRM rodando
                        │
                        ├─ o CRM (site + painel)
...
O G&M CRM roda num **VPS com Docker**. A opção mais fácil é um VPS que **já vem
...
2. Escreva pra ele exatamente isto:
   ...
   > *"Clone https://github.com/melgarafael/G&M CRM e me instale o G&M CRM
...
O G&M CRM foi desenhado pra rodar redondo na infraestrutura da HostGator. Além do
