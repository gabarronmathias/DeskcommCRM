...
**Como funciona:** a submissão **não** vai no README. Vai como um arquivo YAML em [`awesome-selfhosted-data`](https://github.com/awesome-selfhosted/awesome-selfhosted-data), em `software/gm-crm.yml`, um item por PR, nome de arquivo em kebab-case.

**Entrada pronta:** `docs/growth/awesome-selfhosted-gm-crm.yml`. É só copiar o conteúdo abaixo dos comentários. Os nomes de tag e plataforma foram conferidos em 28/07/2026 contra o campo `name:` de cada arquivo do repositório deles — **não** contra o nome do arquivo, que é diferente (`customer-relationship-management-crm.yml` declara `Customer Relationship Management (CRM)`). Referenciar pelo nome do arquivo é a rejeição mais comum.
...
Nome da alternativa: `G&M CRM` · Repositório: `https://github.com/melgarafael/G&M CRM`
