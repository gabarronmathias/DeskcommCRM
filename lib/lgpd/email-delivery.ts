 ...
 *
 * Antes desta fase o nome vinha de `args.organizationName ?? "G&M CRM"`, e
 ...
 * solicitação tinha sido processada pelo G&M CRM. O campo agora é
 ...
 * era o literal `"G&M CRM"` e a questão não existia.
 */
